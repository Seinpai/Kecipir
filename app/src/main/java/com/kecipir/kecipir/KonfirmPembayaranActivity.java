...
public class KonfirmPembayaranActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        layoutBtn = (RelativeLayout) findViewById(R.id.layout_btn_konfirm_bayar);
        spinnerRekening = (Spinner) findViewById(R.id.spinner_rekening);

        edtNamaPemilik = (EditText) findViewById(R.id.edt_konfirmbayar_pemilik);
        edtNoRek = (EditText) findViewById(R.id.edt_konfirmbayar_rekening);
        edtNamaBank = (EditText) findViewById(R.id.edt_konfirmbayar_bank);
        edtTotal = (EditText) findViewById(R.id.edt_konfirmbayar_total);
        edtTglBayar = (EditText) findViewById(R.id.edt_konfirmbayar_tglbyr);
        edtKet = (EditText) findViewById(R.id.edt_konfirmbayar_ket);
            ...
            public void onClick(View v) {
                ...
                if (edtNamaPemilik.getText().toString().equalsIgnoreCase("")||
                    ...
                    mTracker.send(new HitBuilders.EventBuilder()
                            .setCategory("Action")
                            .setAction("Konfirmasi Pembayaran")
                            .build());

                    frameBuffer.setVisibility(View.VISIBLE);
                    confirmBayar(id_user, email, no_nota, idRekening, edtTglBayar.getText().toString(),
    ...
    private void viewKonfirmBayar(final String id_user, final String email, final String no_nota) {
...
//
                        ...
                        ArrayAdapter<String> rekeningAdapter = new ArrayAdapter<String>(KonfirmPembayaranActivity.this, android.R.layout.simple_spinner_item, rekeningList);
...
//                                Toast.makeText(KonfirmPembayaranActivity.this, deliveryType+"-"+ongkir, Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(KonfirmPembayaranActivity.this,
...
//                frameLoading.setVisibility(View.INVISIBLE);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("tag", "viewconfirmpayment");
    ...
    private void confirmBayar(final String id_user, final String email, final String no_nota,
    ...
    private void sendScreenName() {
        String name = "Konfirmasi Pembayaran";

        // [START screen_view_hit]
        Log.i("KonfirmasiPembayaran", "Screen name: " + name);
